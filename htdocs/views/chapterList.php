...
<html lang="es">
    ...
    <body>
                            ...
                            <?php
                                if($comprado == false) { ?>
                                    ...
                                    <div id="paypal-button-container">
                                        <form  method="post" name="RegistroCurso" id="RegistroCurso"></form>
                                    </div>
                                <?php   }   
                            ?>
                        ...
                        <section class="section"> 
                            ...
                            <div class="capitulos-list"> 
                                ...
                                <article class="cursos capitulo sm"> 
                                    ...
                                    <a href="/views/reproductor.php?idCurso=<?php echo $idCurso?>&IdCursoComprado=<?php echo $fila2['IdCursoComprado']?>&IdCapitulo=<?php echo $fila1['IdCapitulo']?>" class="lnk-blk fa-play">
                                        <span aria-hidden="true" hidden="">Ver ahora</span>
                                    </a> 

                                    <?php   }   else    {
                                        if($fila1['Gratis'] == 1)   { ?>
                                            <a href="/views/reproductor.php?idCurso=<?php echo $idCurso?>&IdCursoComprado=0&IdCapitulo=<?php echo $fila1['IdCapitulo']?>" class="lnk-blk fa-play">
                                        <span aria-hidden="true" hidden="">Ver ahora</span>
                                    </a> 
        ...
        <?php
            ...
            //$var = json_encode($filaprecio['Precio_Curso']);
        ?>


        <?php   if($comprado == false) { ?>
            ...
            paypal.Buttons({
                    ...
                    return actions.order.create({
                        purchase_units: [{
                            amount:{
                                ...
                                value:  <?php echo $filaprecio['Precio_Curso']  ?>
                            }
                        }]
                    });
                },
                ...
                onApprove: function(data, actions){
                    actions.order.capture().then(function(detalles){
                        ...
                        ComprarCursoPaypal(<?php echo $fila['idCurso']?>, 1);
