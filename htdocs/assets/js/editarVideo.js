function validacionVideo(){
    ...
    formLogin.onsubmit = function (e) {
        ...
        let idCapitulo = document.getElementById("idCapitulo").value;
        ...
        const curso = {
            ...
            CategoriasCapitulo: 2,

            Curso: courseVideo.trim(),

            IdCapitulo: idCapitulo.trim()
        };
        xhr.open("POST", "/controllers/edit_Capitulo.php", true); // true en modo asicrono
        ...
        //confirm('Video editado exitosamente');
        setTimeout(function(){
